...
def createUser():
    ...
    if form.validate_on_submit():
        ...
        sql = str('CALL NewUser(\"' + form.name.data + '\",\"' + form.password.data + '\",\''  + str(date) + '\',' + str(form.weight.data) + ',' + str(form.weight.data) + "," + str(form.height.data) + ',\"' + form.activity.data + '\",\"' + form.diet.data + '\",' + str(form.budget.data) + ")")
