...
def createUser():
    ...
    if form.validate_on_submit():
        ...
        sql = str('CALL NewUser(%s, %s, %s, %s, %d, %d, %s, %s, %d)' % (form.name.data, form.password.data, date.strftime("%B"), form.gender.data, form.weight.data, form.height.data, str(form.activity.data), form.diet.data, form.budget.data))
